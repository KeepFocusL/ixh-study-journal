        ...
        for (let day = 1; day <= lastDay.getDate(); day++) {
            ...
            if (highlightDatesWithoutMaven.includes(currentDate)) {
                ...
                dayElement.addEventListener('click', () => {
                    ...
                    const url = `https://gitee.com/ggmu_1_0/keep-focus-se/tree/master/lxh-se/src/day${currentDate.toString().slice(2) + urlSuffix}}`;
            ...
            if (highlightDatesWithMaven.includes(currentDate)) {
                ...
                dayElement.addEventListener('click', () => {
                    let urlSuffix = currentDate.toString() >= specialDate ? '/note' : '';
                    const url = `https://gitee.com/ggmu_1_0/lxh-se-maven/tree/master/src/main/java/day${currentDate.toString().slice(2) + urlSuffix}`;
                    window.open(url, '_blank');
                });
            }
